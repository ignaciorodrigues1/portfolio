  ...
  return (
    <section id="performance">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <BigText>Fast, super fast.</BigText>
        <Paragraph>
        Working on code optimization is essential and as important as good design. With Webpack, plugins and minifiers we can achieve a performant application.
        </Paragraph>
      </div>
      <GridLockup
        className="mt-14"
