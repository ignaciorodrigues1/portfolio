  ...
  return (
    <section id="state-variants">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <Paragraph>
          Every detail counts to achieve a great UI, handle states in components, such as <InlineCode>hover</InlineCode>,{' '}<InlineCode>focus</InlineCode>,{' '}
          <InlineCode>active</InlineCode>, <InlineCode>disabled</InlineCode>,{' '}
          <InlineCode>focus-within</InlineCode>, <InlineCode>focus-visible</InlineCode>, <InlineCode>group-hover</InlineCode>.
        </Paragraph>
      </div>
      <GridLockup
