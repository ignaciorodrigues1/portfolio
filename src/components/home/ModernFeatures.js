  ...
  return (
    <section id="modern-features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <Paragraph as="div">
          <p>I take advantage of the latest and greatest CSS features to make the development experience as native as possible. Sometimes less is more and with CSS you can achieve a lot!</p>
        </Paragraph>
        <div className="mt-10">
          <Tabs
            tabs={tabs}
