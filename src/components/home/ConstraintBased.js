  ...
  return (
    <section id="constraint-based" className="relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-indigo-500 dark:text-indigo-400">The way of doing things</Caption>
        <BigText>
          <Widont>Hight experience creating UI design systems</Widont>
        </BigText>
        <Paragraph>
          I understood over time the importance of building a user interface design system for application development and thus facilitating communication between the design and engineering team. Bible that all teams should have from fonts, spaces, components, to concepts and problem solving methodologies.
        </Paragraph>
        <div className="mt-10">
          <Tabs
            tabs={tabs}
