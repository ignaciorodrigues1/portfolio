  ...
  return (
    <section id="component-driven">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-sky-500">Technologies</Caption>
        <BigText>
          <Widont>What's my experience?</Widont>
        </BigText>
        <Paragraph>
          <p>Front End: React, React Native, Angular.js, Next.js, Tailwindcss, PrimeNg, Material.io Ionic, jQuery, SCSS, PostCSS, BEM, Babel, Three, GSAP, WebGL, Cordova, Electron, Webpack, Gulp, Wordpress, HTML, CSS, TypeScript.</p>
          <p>Backend: Node, Firebase, Auth0, WebSockets, MongoDB, GraphQL, NoSQL, MySQL.</p>
          <p>Hosting: Vercel, Netlify, Heroku, Godaddy, Hostinger.</p>
          <p>General: Git/GitHub, Bash, CI and GitHub actions, build systems and custom plugins, CMS, ESlint, Stylelint, Figma for data structure and UI structures.</p>
          <p>Design: Figma, Sketch, Adobe After Effects, Adobe XD, Adobe Photoshop, Adobe Illustrator.</p>
          <p>Productivity: JIRA, Notion, Trello, GSuite, Slack, Skype, Asana.</p>
          <p>Marketing: Mailchimp, Doppler, HubSpot, SendingBlue, Google Ads.</p>
        </Paragraph>
        <div className="mt-10">
          <Tabs
            tabs={tabItems}
