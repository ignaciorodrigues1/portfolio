  ...
  return (
    <section id="build-anything">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <BigText>
          <Widont>I build amazing front-end.</Widont>
        </BigText>
        <Paragraph>
          Each project is a world, and each detail is important. Giving the best of my experience and knowledge in creating interfaces that are unique.
        </Paragraph>
        <div className="mt-10">
          <Tabs
