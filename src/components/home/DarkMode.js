  ...
  return (
    <section id="dark-mode">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <Paragraph>Don’t want to be one of those websites that blinds people when they open it on their phone at 2am? Develop{' '}<InlineCode>dark mode</InlineCode> in your proyect.</Paragraph>
      </div>
      <GridLockup
