...
Either way, please be sure to [check for an existing issue](https://github.com/IgnacioRodrigues/issues) or [open a new one](https://github.com/IgnacioRodrigues/issues/new/choose) so we can figure out the problem and try to improve compatibility with whatever tool you are using.
