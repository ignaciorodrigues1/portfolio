...
See our internal [style definitions](https://github.com/IgnacioRodrigues-typography/blob/master/src/styles.js) for some more examples.
...
See [the default styles](https://github.com/IgnacioRodrigues-typography/blob/master/src/styles.js) for this plugin for more in-depth examples of configuring each modifier.
