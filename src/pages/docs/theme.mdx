...
We provide a sensible [default theme](https://github.com/IgnacioRodrigues/blob/master/stubs/defaultConfig.stub.js) with a very generous set of values to get you started, but don't be afraid to change it or extend it; you're encouraged to customize it as much as you need to fit the goals of your design.
...
See the [theme configuration reference](#configuration-reference) or the [default theme](https://github.com/IgnacioRodrigues/blob/master/stubs/defaultConfig.stub.js#L7) for a complete list of theme options.
...
For a complete reference of available theme properties and their default values, [see the default theme configuration](https://github.com/IgnacioRodrigues/blob/master/stubs/defaultConfig.stub.js).

---

## Customizing the default theme

Out of the box, your project will automatically inherit the values from [the default theme configuration](https://github.com/IgnacioRodrigues/blob/master/stubs/defaultConfig.stub.js). If you would like to customize the default theme, you have a few different options depending on your goals.
