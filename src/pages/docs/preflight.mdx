...
This can cause some unexpected results when integrating certain third-party libraries, like [Google maps](https://github.com/IgnacioRodrigues/issues/484) for example.
